...
<body>
	...
	<c:import url='/WEB-INF/views/includes/navigation.jsp'>
		<c:param name="active" value="loginadmin" />
	</c:import>
	<!-- /.Navigation -->
 	...
 	<div class="container">
 		<div class="card card-container">
            ...
            <form method="post" action="admin/auth" class="form-signin" name="loginForm">
<!--             <form method="post" action="loginadmin" class="form-signin" name="loginForm"> -->
